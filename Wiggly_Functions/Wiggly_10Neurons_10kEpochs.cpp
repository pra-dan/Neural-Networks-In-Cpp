/*Plotting Wiggly Function
 *Author: Prashant Dandriyal
 *-Introduced Automatic Data Normalization
 *-Last: 0.05 @5k epochs,8 Hidden Neurons (Very Amazing)
 **
 **Remember: Normalize the data(test and train), JUST before giving it to the model.
 */
#include <iostream>
#include<vector>
#include <math.h>
